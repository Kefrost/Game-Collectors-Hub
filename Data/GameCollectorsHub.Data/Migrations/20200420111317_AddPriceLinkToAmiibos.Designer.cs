...
namespace GameCollectorsHub.Data.Migrations
{
    ...
    [Migration("20200420111317_AddPriceLinkToAmiibos")]
    partial class AddPriceLinkToAmiibos
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GameCollectorsHub.Data.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("GameCollectorsHub.Data.Models.Game", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("GameCollectorsHub.Data.Models.Setting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("GameCollectorsHub.Data.Models.UserAmiiboCollection", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<int>("AmiiboId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("UserId", "AmiiboId");

                    b.HasIndex("AmiiboId");

                    b.ToTable("UserAmiibosCollection");
                });

            modelBuilder.Entity("GameCollectorsHub.Data.Models.UserConsoleCollection", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasKey("UserId", "GameConsoleId");

                    b.HasIndex("GameConsoleId");

                    b.ToTable("UserConsolesCollection");
                });

            modelBuilder.Entity("GameCollectorsHub.Data.Models.UserGameCollection", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<bool>("ManualIncluded")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("GameCollectorsHub.Data.Models.UserAmiiboCollection", b =>
                {
                    b.HasOne("GameCollectorsHub.Data.Models.Amiibo", "Amiibo")
                        .WithMany("UserAmiibosCollection")
            ...
            modelBuilder.Entity("GameCollectorsHub.Data.Models.UserConsoleCollection", b =>
                {
                    b.HasOne("GameCollectorsHub.Data.Models.GameConsole", "GameConsole")
                        .WithMany("UserConsolesCollection")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("GameCollectorsHub.Data.Models.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("GameCollectorsHub.Data.Models.ApplicationUser", null)
                        .WithMany("Claims")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
